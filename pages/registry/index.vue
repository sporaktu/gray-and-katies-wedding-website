                  ...
                  <div :class="$style['logo-container']" v-if="store">
                    ...
                    <svg v-else-if="item.store === 'Bed, Bath and Beyond'" viewBox="0 0 127 39" class="currColor"
                      ...
                      <g fill="currentColor" fill-rule="evenodd">
                        ...
                        <path
                          d="M62.691 14.96l-2.2 4.826h-2.587L67.12-.286l9.214 20.072h-2.585l-2.201-4.827H62.69zm4.428-9.984l-3.43 7.787h6.86l-3.43-7.787z"></path>
                        <path fill-rule="nonzero"
  ...
  methods: {
    storeLogo(store) {
      switch (store) {
        ...
        case 'Amazon':
          return 'https://s3.amazonaws.com/prod-widgetSource/in-shop/pub/images/amzn_favicon_blk.png';
        default:
          '';
      }
    }
